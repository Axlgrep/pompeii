...
int main() {
  ...
  for (int32_t idx = 0; idx < 10; idx++) {
    std::string key = "set_key_" + std::to_string(idx);
  ...
  for (int32_t idx = 0; idx < 10; idx++) {
    std::string key = "zset_key_" + std::to_string(idx);
  ...
  for (int32_t idx = 0; idx < 10; idx++) {
    std::string key = "hset_key_" + std::to_string(idx);
  ...
  for (int32_t idx = 0; idx < 10; idx++) {
    std::string key = "list_key_" + std::to_string(idx);
